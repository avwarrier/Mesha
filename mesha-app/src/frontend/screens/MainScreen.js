  ...
  return (
    <div className='h-[100vh] bg-[#faefd2]'>
            ...
            <m.div exit={{opacity: 0}} initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 0.70}} className='m-auto h-[400px] w-[500px] mt-[10vh] flex flex-col justify-center items-center'>
                ...
                <Link to="/getstarted"><div className='h-[50px] w-[200px] bg-[#222] flex justify-center items-center text-[#faefd2] rounded-md mt-[20px] cursor-pointer shadow-md transition eas-in-out delay-90 hover:shadow-lg hover:bg-[#333]'>Get Started</div></Link>
            </m.div>
    </div>
  )
}
