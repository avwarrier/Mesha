    ...
    return (
        ...
        <div className='h-[100vh] bg-[#ffffff] '>
            ...
            <m.div exit={{opacity: 0}} initial={{opacity: 0}} animate={{opacity: 1}}className='h-[350px] w-[400px] drop-shadow-md rounded-md bg-[#ffffff] mt-[15vh] m-auto flex flex-col items-center justify-center gap-[10px]'>
                <div className='flex items-center justify-between bg-white h-[50px] w-[300px] border-[1.5px] border-[#4a6a8f] rounded-xl cursor-pointer transition eas-in-out delay-90 hover:shadow-md' onClick={googleAuthSignUp}>
                ...
                <div className='h-[180px] w-[300px] flex flex-col items-center justify-center gap-[20px] mt-[15px]'>
                    ...
                    }} placeholder={!shortPass ? 'password (8 characters)' : 'must be 8 or more characters'} type="password" className={!shortPass ? 'outline-none bg-[#eaeaea] font-light placeholder:font-thin placeholder:text-[#4a6a8f] h-[45px] w-[300px] p-[20px] rounded-xl' : 'outline-none bg-[#eaeaea] font-light placeholder:font-thin placeholder:text-red-700 h-[45px] w-[300px] p-[20px] rounded-xl border-red-400 border-2'}/>
